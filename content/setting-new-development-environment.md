...
I work mainly with python so I include [pyenv](https://github.com/yyuu/pyenv) in my setup script. Instead of being dependent on whichever version ship with the OS, with `pyenv` I can have concurrent, self-contained, python installations. If you're interested in trying it out check out my pyenv tutorial!
